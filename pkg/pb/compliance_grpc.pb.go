...
const (
	ComplianceService_ScreenTransaction_FullMethodName = "/compliance.ComplianceService/ScreenTransaction"
)
...
type ComplianceServiceClient interface {
	ScreenTransaction(ctx context.Context, in *ScreenTransactionRequest, opts ...grpc.CallOption) (*ScreenTransactionResponse, error)
}
...
func (c *complianceServiceClient) ScreenTransaction(ctx context.Context, in *ScreenTransactionRequest, opts ...grpc.CallOption) (*ScreenTransactionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ScreenTransactionResponse)
	err := c.cc.Invoke(ctx, ComplianceService_ScreenTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ComplianceServiceServer interface {
	ScreenTransaction(context.Context, *ScreenTransactionRequest) (*ScreenTransactionResponse, error)
...
func (UnimplementedComplianceServiceServer) ScreenTransaction(context.Context, *ScreenTransactionRequest) (*ScreenTransactionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ScreenTransaction not implemented")
}
...
func _ComplianceService_ScreenTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ScreenTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ComplianceServiceServer).ScreenTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ComplianceService_ScreenTransaction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ComplianceServiceServer).ScreenTransaction(ctx, req.(*ScreenTransactionRequest))
	}
...
var ComplianceService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ScreenTransaction",
			Handler:    _ComplianceService_ScreenTransaction_Handler,
		},
	},
